# Generated by Django 5.1.2 on 2024-11-28 13:38
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tojuweb', '0003_alter_product_image'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='tojuweb.product')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
