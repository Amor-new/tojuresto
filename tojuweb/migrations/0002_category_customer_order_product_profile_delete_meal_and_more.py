# Generated by Django 5.1.2 on 2024-11-14 23:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tojuweb.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('category', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='tojuweb.category')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
        ...
        migrations.AddField(
            model_name='order',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tojuweb.product'),
        ),
    ]
